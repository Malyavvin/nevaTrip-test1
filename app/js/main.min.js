const yetBtn=document.querySelector(".yet"),hiddenCruise=document.querySelectorAll(".hidden__block");yetBtn.onclick=e=>{e.preventDefault(),hiddenCruise.forEach((e=>{e.style.display="flex",yetBtn.style.display="none"}))}
/*!
